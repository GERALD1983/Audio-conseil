  ...
  <div class="paddingTopPage text-secondary">
    ...
    <div class="flexCenter">
      ...
      >
        ...
        lesquelles ils vous seront utiles dans votre vie quotidienne.
      </p>
    </div>
    <div class="flexCenter">
      <div id="ancreBaignade" class="mt-5 col-md-8 flexColumnCenter">
        ...
        <div class="flexColumnCenter">
          ...
          >
            ...
            <p class="text-center">
              « Nous fabriquons des bouchons sur-mesure, en silicone, totalement
              obturant. Ils allient confort, performance et simplicité
              d'utilisation. »
            </p>
          </div>
          <div
      ...
      <div id="ancreNuisance" class="mt-5 col-md-8 flexColumnCenter">
        ...
        <div class="flexColumnCenter">
          ...
          >
            ...
            <p class="text-center">
              « Ces protections auditives sont des embouts sur-mesure, équipés
              de filtres acoustiques. Le rôle de ce filtre est de limiter les
          ...
          >
            ...
            <p class="text-center">
              De nombreuses personnes sont exposées aux bruits dans le cadre de
              leur travail et bien souvent sans protection ! L'utilisation de
              bouchons adaptés soulage ainsi des troubles de la fatigue
              auditive, et peut empêcher l'apparition des acouphènes,
              particulièrement gênants. <br />
              <br />
              Dans une ville, dans les transports, au travail, la vie d'une
              personne souffrant d'hyperacousie peu devenir un enfer au point
              qu'elle s'interdira de fréquenter tous ces lieux qui font pourtant
              partie de la vie de tous les jours. La seule solution est de
              filtrer le bruit, sans se couper du monde. <br />
              <br />
              Nous rencontrons souvent des gens dans le métro portant des boules
              de coton dans les oreilles pour limiter les bruits de rails et de
              freinage. Ces solutions artisanales ont le mérite d'exister, mais
              les retours d'information de nos clients nous permettent de penser
              que nos produits assurent un résultat sensiblement meilleur.
              <br />
              <br />
              L'atténuation progressive permet de rester en contact avec votre
              environnement, mais comprime le bruit pour le bloquer à un niveau
              confortable. <br />
              <br />
              En silicone très souple, mise en place facile, parfait maintien,
              Très grand confort dans l'oreille en toute position, Atténuation
              sonore progressive en position ouverte . Autres utilisations :
      ...
      <div id="ancreSommeil" class="mt-5 col-md-8 flexColumnCenter">
        ...
        <div class="flexColumnCenter">
          ...
          >
            ...
            <p class="text-center">
              « Pour retrouver des nuits sereines, essayez les bouchons
              anti-bruit spécialement conçus pour la nuit. » <br />
              <br />
              Ils vous protègent des bruits venant troubler votre tranquillité.
              Leur forme est particulièrement fine et ils sont réalisés dans un
              silicone extra souple, spécialement étudié pour éviter toute
              sensation de gêne durant votre sommeil. Ils sont également très
              utiles en voyage.
            </p>
          </div>
          <div
